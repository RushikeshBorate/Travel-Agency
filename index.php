...
<body>
    ...
    <header class="">
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="index.php"><h2>Booking <em>.com</em></h2></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo $loginLink; ?>"><?php echo $loginText; ?></a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="package-details.php"><h4>Iconic Cities</h4></a>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="package-details.php"><h4> Country Side </h4></a>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="package-details.php"><h4>Historical Sites</h4></a>
                ...
                <small>
                     <strong title="Available"><i class="fa fa-calendar"></i> Summer</strong> &nbsp;&nbsp;&nbsp;&nbsp;
                     <strong title="Nights"><i class="fa fa-cube"></i> 20 nights</strong> &nbsp;&nbsp;&nbsp;&nbsp;
                     <!-- <strong title="Flight included"><i class="fa fa-plane"></i> Flight included</strong> -->
                </small>
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item">
              ...
              <div class="down-content">
                ...
                <p style="margin: 0;"> John Doe &nbsp;&nbsp;|&nbsp;&nbsp; 12/01/2024 10:30 &nbsp;&nbsp;|&nbsp;&nbsp; 114</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
              <p>Copyright © 2020 Company Name - Template by: <a href="https://www.phpjabbers.com/">Booking.com</a></p>
            </div>
          </div>
        </div>
      </div>
