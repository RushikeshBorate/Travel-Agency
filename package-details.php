...
<html lang="en">
  ...
  <head>
    ...
    <title>Booking.com | Package</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php"><h2>Package <em>Detail</em></h2></a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              ...
              <h2>package details and offers</h2>
            </div>
          </div>
        </div>
      </div>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
               ...
               <tbody>
                    ...
                    <tr>
                         ...
                         <td>01-06-2022</td>
                         <td>31-12-2022</td>
                         <td>₹ 28000 per night</td>
                    </tr>
                    <tr>
                         <td></td>
                         <td>01-06-2022</td>
                         <td>31-12-2022</td>
                         <td>₹ 40000 total price</td>
                    </tr> 
               </tbody>
          </table>
        </div>
          ...
          <div class="col-md-3">
            ...
            <div class="left-content">
              ...
              <p>
                ...
                <strong>
                  <a href="mailto:john@booking.com">john@booking.com</a>
                </strong>
              </p>
    ...
    <!-- Header -->
    <header class="">
        <?php include 'header.php'; ?> <!-- Include the common header file -->
